...
#else
#define U8TO64(p) (*(const unsigned long long *)(p))
#endif
...
#else
#define U64TO8(p,v) ((*(unsigned long long *)(p)) = (v))
#endif
...
void Poly1305_compute(void *auth,const void *data,unsigned int len,const void *key)
{
  ...
  poly1305_init(&ctx,(const unsigned char *)(key));
  poly1305_update(&ctx,(const unsigned char *)(data),(size_t)len);
  poly1305_finish(&ctx,(unsigned char *)(auth));
}
